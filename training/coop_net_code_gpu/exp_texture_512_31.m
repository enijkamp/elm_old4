...
% (30) refine (29)
num = 1;
Deltas2 = [0.003]; % [0.001 0.003];
Gammas2 = [10 15];
for Delta2 = Deltas2
    for Gamma2 = Gammas2
        % prep
        prefix = [img_name '/' num2str(img_size) '_31_' num2str(num) '/'];
        ...
        config.Gamma2 = [0.0002*ones(1,100), 0.0001*ones(1,100), 0.00008*ones(1,100), 0.00006*ones(1,100), 0.00004*ones(1,100)] * Gamma2; % reduced first 100
        config.refsig2 = 1;
        config.s = 0.3;
        config.real_ref = 1;
        config.cap2 = 8;
